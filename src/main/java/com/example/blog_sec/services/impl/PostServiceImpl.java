...
import com.example.blog_sec.repositories.PostRepository;
import com.example.blog_sec.services.CategoryService;
import com.example.blog_sec.services.PostService;
...
public class PostServiceImpl implements PostService {
    ...
    public void deletePost(UUID id) {
        //to check whether the post exists (if don't find id, getPost method will throw exception)
